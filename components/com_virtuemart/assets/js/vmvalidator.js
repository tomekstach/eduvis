...
function myValidator(f, r) {
  ...
  if (document.formvalidator.isValid(f)) {
    ...
    if (jQuery('#zip_field').length) {
      console.log('ZIP field!!!');
      if (/^\d{2}\-\d{3}$/.test(jQuery('#zip_field').val())) {
        console.log('ZIP valid!!!');
        jQuery('#zip_field').removeClass('invalid');
        jQuery('#zip_field').attr('aria-invalid', 'false');
        jQuery('[for="zip_field"]').removeClass('invalid');
        ...
        jQuery('#zip_field').addClass('invalid');
        jQuery('#zip_field').attr('aria-invalid', 'true');
        jQuery('[for="zip_field"]').addClass('invalid');
      }
    }
  } else {
