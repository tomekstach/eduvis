...
?>
<div class="vmgroup<?php echo $params->get ('moduleclass_sfx') ?> vmproduct-list list-layout">
			...
			<div class="<?php echo $pwidth ?> <?php echo $float ?>">
				<div class="spacer">
					...
					<div class="vm-prd-listing-info">
						...
						<a class="vm-prd-name" href="<?php echo $url ?>">
						...
						if ($show_price) { ?>
							<div class="sp-price-box">
								<?php if ( isset($product->prices['product_override_price']) && round($product->prices['product_override_price']) != 0) { ?>
						            ...
						            <del>
						            	<?php echo $currency->createPriceDiv ('basePriceWithTax', '', $product->prices, FALSE, FALSE, 1.0, TRUE); ?>
						            </del>
