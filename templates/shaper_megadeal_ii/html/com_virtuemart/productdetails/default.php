...
<div class="productdetails-view productdetails">
	    ...
	    <div class="row">
			...
			<div class="vm-product-details-container col-sm-6">
			    ...
			    <div class="spacer-buy-area">
					...
					<!-- AstoSoft - start -->
					<div><strong>Kod produktu:</strong> <?php echo $this->product->product_sku ?></div>
					<!-- AstoSoft - end -->
					...
					<div class="product-price" id="productPrice<?php echo $this->product->virtuemart_product_id ?>">
						...
						<div class="vm-product-countdown-wrapper">
							...
							<?php if ( isset($this->product->prices['product_override_price']) && round($this->product->prices['product_override_price']) != 0 ) { ?>
								<div class="vm-price-save">
									<div class="vm-countdown-save">
										...
										<h2 class="vm-discount-ammount">
											...
											<?php echo $this->currency->createPriceDiv ('discountAmount', '', $this->product->prices); ?>
										</h2>
									</div>
								</div><!-- //sp-price-save
							<?php } ?>
	...
	<div class="productdetails-view-section vm-product-details-infos">
		...
		<div class="tab-content">
			...
			<!-- AstoSoft - start <div id="vm-product-review" class="tab-pane" role="tabpanel" >
