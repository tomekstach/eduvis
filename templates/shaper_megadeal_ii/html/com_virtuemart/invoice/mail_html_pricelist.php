...
<?php if ($this->doctype == 'invoice') { ?>
	<tr class="sectiontableentry1">
		<td colspan="5" align="right" style="border: 1px solid #CCCCCC;"><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_PRODUCT_PRICES_TOTAL'); ?></td>
		<?php if ( VmConfig::get('show_tax')) { ?>
	...
	?>
	<tr>
		<td align="right" style="border: 1px solid #CCCCCC;" class="pricePad" colspan="5"><?php echo vmText::_('COM_VIRTUEMART_COUPON_DISCOUNT').$coupon_code ?></td>
		<?php if ( VmConfig::get('show_tax')) { ?>
	...
	<tr >
		<td colspan="5" align="right" style="border: 1px solid #CCCCCC;" class="pricePad"><?php echo $rule->calc_rule_name ?> </td>
		<?php if ( VmConfig::get('show_tax')) { ?>
		<td align="right" style="border: 1px solid #CCCCCC;">&nbsp;</td>
		<?php } ?>
	...
	<tr>
		<td align="right" style="border: 1px solid #CCCCCC;" class="pricePad" colspan="5"><?php echo $this->orderDetails['shipmentName'] ?></td>
		<?php if ( VmConfig::get('show_tax')) { ?>
	...
	<tr>
		<td align="right" style="border: 1px solid #CCCCCC;" class="pricePad" colspan="5"><strong><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_TOTAL') ?></strong></td>
		<?php if ( VmConfig::get('show_tax')) { ?>
	...
	?>
	<tr>
		<td align="right" style="border: 1px solid #CCCCCC;" class="pricePad" colspan="5"><strong><?php echo vmText::_('COM_VM_TOTAL_IN_PAYMENT_CURRENCY') ?></strong></td>
	...
	if($taxBill){
		?>
		<tr>
			<td colspan="6" align="right" style="border: 1px solid #CCCCCC;" class="pricePad"><?php echo vmText::_('COM_VIRTUEMART_TOTAL_INCL_TAX') ?> </td>
			<?php if ( VmConfig::get('show_tax')) {  ?>
		...
		foreach($taxBill as $rule){
			if ($rule->calc_kind == 'taxRulesBill' or $rule->calc_kind == 'VatTax' ) { ?>
				<tr >
					<td colspan="5" align="right" style="border: 1px solid #CCCCCC;" class="pricePad"><?php echo $rule->label ?> </td>
					<?php if ( VmConfig::get('show_tax')) {  ?>
