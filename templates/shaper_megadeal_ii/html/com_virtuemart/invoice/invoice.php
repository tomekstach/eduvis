...
<br clear="all"/><br/>
    <?php    
if ($this->headFooter and strpos($this->orderDetails['paymentName'], 'przedp')) {
    echo $this->replaceVendorFields($this->vendor->vendor_letter_footer_html, $this->vendor);
}

if ($this->vendor->vendor_letter_add_tos and strpos($this->orderDetails['paymentName'], 'przedp')) {?>
