...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
  ...
  <tr>
    ...
    <td class="orders-key" align="left">
      <strong><?php echo $this->currency->priceDisplay($this->orderDetails['details']['BT']->order_total, $this->user_currency_id); ?></strong>
    </td>
  </tr>
  <?php } ?>
  ...
  <tr>
    <td valign="top"><strong>
      ...
      <table border="0"><?php
                        foreach ($this->userfields['fields'] as $field) {
                          if (!empty($field['value']) and !in_array($field['name'], ['email', 'phone_1', 'first_name', 'last_name', 'customer_note', 'address_type_name', 'name'])) {
    ...
    <td valign="top"><strong>
      ...
      <?php if (!empty($this->orderDetails['details']['has_ST'])) {
        ...
        echo "<br/>" . vmText::_('COM_VM_ST_SAME_AS_BT_2');
      }
