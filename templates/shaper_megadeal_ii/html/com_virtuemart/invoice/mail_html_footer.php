...
<?php if ($this->vendor->vendor_letter_footer == 1 and strpos($this->orderDetails['paymentName'], 'przedp')) { ?>
...
<p>W tytule przelewu prosimy wpisać numer zamówienia: <?php echo $this->orderDetails['details']['BT']->order_number; ?></p>
</div>
