	    ...
	    <?php if ( isset($product->prices['product_override_price']) && round($product->prices['product_override_price']) != 0) { ?>
	    	<ins>
	            <?php //echo $currency->createPriceDiv ('salesPrice', '', $product->prices, FALSE, FALSE, 1.0, TRUE); ?>
							<?php // AstoSoft ?>
	            <?php echo $currency->createPriceDiv ('salesPrice', 'Cena brutto:', $product->prices); ?>
	        </ins>
					<!-- AstoSoft - start
	        <del>
	            <?php //echo $currency->createPriceDiv ('product_price', '', $product->prices, FALSE, FALSE, 1.0, TRUE); ?>
	            <?php //echo $currency->createPriceDiv ('basePriceVariant', FALSE, $product->prices); ?>
	        </del>
