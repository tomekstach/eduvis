...
<form method="post" id="adminForm" name="userForm" action="<?php echo JRoute::_('index.php?option=com_virtuemart&view=user', $this->useXHTML, $this->useSSL) ?>" class="form-validate vm-edit-user-form">
  <?php if ($this->userDetails->user_is_vendor or $this->userDetails->virtuemart_user_id == 0) { ?>
