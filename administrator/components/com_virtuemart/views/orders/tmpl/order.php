          ...
          <thead>
            <tr>
              ...
              <th><?php
                  ...
                  /*($this->orderbt->paid, $this->orderID,'toggle.paid'); */
                  echo $this->currency->priceDisplay($this->orderbt->paid); ?></th>
              <th>
                <?php
        ...
        <table class="adminlist table">
          ...
          <tr>
            <td colspan="4">
              ...
              <div style="display: none; background: white; z-index: 100;" class="element-hidden vm-absolute" id="updateOrderStatus"><?php echo $this->loadTemplate('editstatus'); ?>
              </div>
            </td>
          </tr>
    ...
    <tr id="updateOrderItemStatus" class="viewMode">
      <td colspan="11">
        ...
        <?php if (vmAccess::manager('orders.status') or vmAccess::manager('orders.edit')) { ?>
          <a class="btn btn-small  updateOrderItemStatus orderEdit" href="#"><span class="icon-nofloat vmicon vmicon-16-save"></span><?php echo vmText::_('COM_VIRTUEMART_ORDER_ITEMS_SAVE'); ?></a>
        <?php } ?>
      </td>
    </tr>
  </table>
            ...
            <thead>
              <tr>
                ...
                <th class="title" width="50"><?php
                                              ...
                                              //echo vmText::_('COM_VIRTUEMART_PRODUCT_FORM_PRICE_TAX') 
                                              ?></th>
